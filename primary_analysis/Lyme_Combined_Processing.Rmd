...
```{r}
knitr::include_graphics(path = here::here("primary_analysis",
...
```{r}
#| child = here::here("primary_analysis", "notebooks", "01-setup.Rmd")
```
...
```{r}
#| child = here::here("primary_analysis", "notebooks", "02-functions.Rmd"),
...
```{r}
#| child = here::here("primary_analysis", "notebooks", "03-meta.Rmd")
```
...
- <a href="./notebooks/downstream/pathway_analysis.html" target="_blank">Pathway analysis</a> (including pseudobulk differential expression)
- <a href="./notebooks/downstream/signaling.html" target="_blank">Signaling</a> (CellChat for ligand-receptor pairing)
...
* <a href="./notebooks/other/resolution_choices.html" target="_blank">Clustering resolution choices</a> (visualization of clusters to choose how many to annotate on)
