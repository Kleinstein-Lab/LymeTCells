...
#' @param tissue_type The type of tissue being plotted: "Blood" or "Skin".
#' @param clrs_specific The specific color palette (should be named).
...
#' @param airr_type Type of immune receptor data. Default is "TCR".
...
#' @param overview Whether to print integration summary information. Default is TRUE.
#'
