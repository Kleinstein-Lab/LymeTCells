...
With the AIRR data filtered down to just the blood and the β chains:
...
ggVennDiagram(
  ...
  labs(title = "Subclustered Blood T Cells",
       subtitle = "ID Overlaps across Assays", fill = "Cell Count") +
...
With the AIRR data filtered down to just the skin and the β chains:
