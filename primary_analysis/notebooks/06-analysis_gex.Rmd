...
Upon more careful examination, we noticed that the plasma cells (cluster 15) had some T cell markers and decided to subcluster them:
...
# choose a resolution
# a higher resolution separates out the B cells better
...
FeaturePlot(combined_skin,
            features = get_features_from_all(markers_df = markers_all,
                                             sources = c(markers_skin_sources,
                                                         "Ira_Fleming"),
                                             cell_types = "NK"),
            min.cutoff = 0, label = TRUE, label.size = 2,
            ncol = 4, raster = FALSE) +
...
* It was suggested that plotting pan-myeloid markers to help identify actual mast cells
...
combined_skin_annotations <- rbind(c("0", "T Cells"), # CD4 T Cells
                                   ...
                                   c("34", "Nerves"),
                                   c("35", "Fibroblasts"),
                                   c("36", "Cycling Dendritic Cells"),
                                   c("37", "Keratinocytes"),
                                   c("38", "Mast Cells"),
                                   c("39", "Endothelial Cells"),
                                   c("40", "Keratinocytes"),
