...
Sometimes people just use high RNA counts, but there are some cell types that do genuinely just have high counts without being doublets.
...
# we ended up with a doublet rate closer to 4.5%
```
