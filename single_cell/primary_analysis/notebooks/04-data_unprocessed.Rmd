...
Aggregation was done to help deal with the significant differences in read depth identified in the QC.

The full run details can be found in the "generate_aggr_csv.R" and "cellranger_aggr.sh" files within the cellranger subdirectory in the lyme repository. This is the actual script that was run:

```{bash cellranger-command}
...
# user-specific
id="aggr"
csv_dir="/home/edelaron/git/Research/lyme/single_cell/primary_analysis/cellranger"
