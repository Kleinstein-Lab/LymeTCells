...
Chosen resolution of `r blood_res`:
...
umaps_res[[blood_res]] <-
  umaps_res[[blood_res]] + theme(plot.title = element_text(color = "red"))
...
Chosen resolution of `r skin_res`:
...
# highlight my current chosen resolution
umaps_res[[skin_res]] <-
  umaps_res[[skin_res]] + theme(plot.title = element_text(color = "red"))
...
Chosen resolution of `r blood_t_res`:
...
# highlight my current chosen resolution
umaps_res[[blood_t_res]] <-
  umaps_res[[blood_t_res]] + theme(plot.title = element_text(color = "red"))
...
Chosen resolution of `r skin_t_res`:
...
# highlight my current chosen resolution
umaps_res[[skin_t_res]] <-
  umaps_res[[skin_t_res]] + theme(plot.title = element_text(color = "red"))
...
Chosen resolution of `r blood_t_ref_res`:
...
# highlight my current chosen resolution
umaps_res[[blood_t_ref_res]] <-
  umaps_res[[blood_t_ref_res]] + theme(plot.title = element_text(color = "red"))
...
Chosen resolution of `r skin_t_ref_res`:
...
# highlight my current chosen resolution
umaps_res[[skin_t_ref_res]] <-
  umaps_res[[skin_t_ref_res]] + theme(plot.title = element_text(color = "red"))
